...
//13.5.2 Create the map object with center at the San Francisco airport. Note: The L.geoJSON()layer reverses the coordinates to plot them on the map.
...
// Grabbing our GeoJSON data. Add city to marker with bindPopup
// L.geoJson(sanFranAirport, {
//     pointToLayer: function(feature, latlng) {
//       console.log(feature);
//       return L.marker(latlng)
...
// Grabbing our GeoJSON data. Use onEachFreature callback function to add multiple items to marker
L.geoJson(sanFranAirport, {
